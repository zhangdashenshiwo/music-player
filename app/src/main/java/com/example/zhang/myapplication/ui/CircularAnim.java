package com.example.zhang.myapplication.ui;
...
public class CircularAnim {
    ...
    public static class VisibleBuilder {
         ...
         * 设置触发器视图。
         *
         * 如果{@link VisibleBuilder\mTriggerPoint}为空，
         *
         * 然后将mTriggerView的中心设置为触发点。
         */
    ...
    public static class FullActivityBuilder {
        ...
        //动画结束监听者
        private OnAnimationEndListener mOnAnimationEndListener;
        //fade_in,fade_out为系统中有两个定义好的Activity跳转动画
